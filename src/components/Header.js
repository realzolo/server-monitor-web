...
function Header({ config }) {
    const {site_title, github, telegram} = config;
    const [state, setState] = useState({ title: "SSProbe", github: "", telegram: "" });
    useEffect(() => {
    ...
    return (
        <div className="header_wrapper">
            <div className="header_title">
                <svg height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="var(--color-text-1)">
            ...
            <div className="head_contact">
                {
                    state.github && (
                        <a href={state.github}>
                            <svg height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="var(--color-text-1)">
